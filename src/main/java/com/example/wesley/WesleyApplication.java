...
public class WesleyApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria silva", "maria@gmail.com", "12821209120", TipoCliente.PESSOAFISICA);
